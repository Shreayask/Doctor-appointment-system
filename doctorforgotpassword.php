...
if (isset($_POST['submit'])) {
    ...
    $user = "SELECT * FROM doctor WHERE loginid='$_POST[login]' AND doctorphoneno='$_POST[phone]'";
    $chkuser = mysqli_query($con, $user);
    $rs = mysqli_fetch_array($chkuser);
    if ((mysqli_num_rows($chkuser) == 1)) {

        echo " <script> location.href='newdocpassword.php?doctorid=$rs[doctorid]'</script>";
    } else {
        ...
        <div class="body">
            ...
            <form name="loginform" method="post" action="">
                ...
                <table cellspacing="7" cellpadding="4" align="center" style="background-color: white; border: 2px white; border-radius: 25px; opacity: 5px;">
                    ...
                    <tr>
                        <td colspan="5">
                            <font size="3" face="cambria"><b>&#8196;&#8196;&#8196;Login ID:</b></font><br>&#8196;&#8196;&#8196;<input type="text" class="no-outline" name="login" style="border-left: none; border-top: none; border-right: none; height: 30px; width: 315px;" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5">
