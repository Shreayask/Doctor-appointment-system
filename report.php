...
treatmentrecords.treatmentid=treatment.Treatmentid and treatmentrecords.appointmentid='$_GET[appointmentid]' and treatmentrecords.patientid='$_GET[patientid]'";
                                        ...
                                        if (!isset($_SESSION['patientid'])) {
                                            echo "<tr> ";
                                            echo "<td colspan='5' style='text-align: center;'><button name='addtreatment' style='width: 100%;'>
<a href='addtreatmentrecord.php?appointmentid=$_GET[appointmentid]&patientid=$_GET[patientid]&doctorid=$rsdoc[doctorid]' style='text-decoration:none;'> Add Treatment  </a> </button> </td>
</tr>
<tr> ";
                                            echo "<td colspan='5' style='text-align: center;'><button name='addtreatment' >
