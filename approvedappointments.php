            ...
            <div class="left">
                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        <th>
                            <font size="4" face="arial" color="gainsboro"><a href="doc changepassword.php" target="_self" id="a">&#8196;&#8196;&#8196;&#8196;&#8196;Change Password&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;</a></font>
                        </th>
                    </tr>
                    <tr>
                        <td></td>
                ...
                <div class="admintop">
                    ...
                    <table class="order-table" width="975" border="7" cellpadding="4" align="center" style="border-radius: 3px; border-color: lightslategray;">
                        <thead style="font-size: 16px; background-color: mediumpurple;">
                            <tr>
                                <th width="15%" height="45">Patient detail</th>
                        ...
                        <tbody style="text-align: center; font-size: 16.5px; color: black; background-color: thistle;">
                            ...
                            if (isset($_SESSION['doctorid'])) {
                                $sql = "SELECT * from appointment WHERE status='Approved' AND doctorid='$_SESSION[doctorid]'";
                                ...
                                while ($rs = mysqli_fetch_array($csql)) {
                                    ...
                                    if ($rs['status'] != "Approved") {
                                        ...
                                        echo "<a href='patientreports.php?patientid=$rs[patientid]&appointmentid=$rs[appointmentid]'>View Report</a><hr>";
                                        echo "  <a href='viewapprovedappointment.php?delid=$rs[appointmentid]'>Delete</a>";
                                    }
                                    echo "</td></tr>";
                                }
                            }
