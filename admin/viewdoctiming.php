        ...
        <div class="body">
            ...
            <div class="right">
                ...
                <div class="admintop">
                    ...
                    <h3>&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;Search Doctor - <input type="search" class="light-table-filter" data-table="order-table" placeholder="Search" /></h3><br>
                    <table class="order-table" width="750" border="7" cellpadding="7" cellspacing="2" align="center" style="border-radius: 3px; border-color: lightslategray;">
                        <thead style="font-size: 16.5px; background-color: lightblue;">


                            <tr>
                                <th width="15%" height="40">Doctor ID</th>
                                <th width="23%">Doctor Name</th>
          ...
          <td>$rs[doctorid]</td>
           ...
           <td>$rs[status]</td>
        <td>
		   <a href='viewtiming.php?doctorid=$rs[doctorid]'>View and Edit Timing</a>  </td>
        </tr>";
                                }
                            }
                            ?> </tbody>
