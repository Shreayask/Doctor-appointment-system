    ...
    <div class="body">
      ...
      <div class="right">
        ...
        <div class="admintop">
          ...
          <h2 align="center" style="color: black">Add New Department Record</h2><br>
          <form method="post" action="" name="frmdept" onSubmit="return validateform()">
            <table width="500" align="center" border="3" style="font-size: 18px; border-radius: 3px;" cellpadding="7">
              <tr>
                ...
                <td id="y"><input type="text" name="departmentname" id="departmentname" style="font-size: 17px;" size="29"></td>
              </tr>
              <tr>
                <td id="x">Description</td>
                <td id="y"><input name="description" id="textarea" style="font-size: 17px;" size="29"></input></td>
              </tr>
              <tr>
                <td id="x">Status</td>
                <td id="y">
                  <select name="status" id="select" style="font-size: 17px;">
          ...
          <script type="application/javascript">
            ...
            function validateform() {
              if (document.frmdept.departmentname.value == "") {
                ...
                return false;
              } else if (document.frmdept.description.value == "") {
                alert("Kindly select the description..");
                document.frmdept.description.focus();
                return false;
              } else {
                return true;
              }
