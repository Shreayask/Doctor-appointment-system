            ...
            <div class="right">
                ...
                <div class="admintop">
                    ...
                    if (isset($_POST['submit'])) {
                        $sql = "UPDATE treatment SET Treatment_Type='$_POST[treatmenttype]',Treatment_Cost='$_POST[treatmentcost]',Description='$_POST[textarea]',Status='$_POST[select]' WHERE treatmentid='$_GET[editid]'";
                        if ($qsql = mysqli_query($con, $sql)) {
                            echo "<script>alert('Treatment record updated successfully.');
			location.href='viewtreatmenttype.php';</script>";
                        } else {
                            echo "<script>alert('Failed to update Treatment.');
			location.href='viewtreatments.php';</script>";
                        }
                    }
                    ...
                    ?>
                    <h2 align="center" style="color: black">Treatment Type Record</h2><br>
                        ...
                        <table width="500" align="center" border="3" style="font-size: 17px; border-radius: 3px;" cellpadding="7">
                            <tbody>
                                <tr>
                                    ...
                                    <td id="y"><input type="text" name="treatmenttype" id="treatmenttype" value="<?php echo $rsedit['Treatment_Type']; ?>" style="font-size: 16.5px;" size="31" /></td>
                                </tr>
                                <tr>
                                <tr>
                                    <td id="x">Treatment Cost</td>
                                    <td id="y"><input type="text" name="treatmentcost" id="treatmentcost" value="<?php echo $rsedit['Treatment_Cost']; ?>" style="font-size: 16.5px;" size="31" /></td>
                                </tr>
                                <tr>
                                    <td id="x">Note</td>
                                    <td id="y"><textarea name="textarea" id="textarea" cols="30" rows="3" style="font-size: 16.5px;" size="31"><?php echo $rsedit['Description']; ?></textarea></td>
                                </tr>
                                <tr>
                                    <td id="x">Status</td>
                                    <td id="y">
                                        <p>
                                            <select name="select" id="select" style="font-size: 16.5px;">
