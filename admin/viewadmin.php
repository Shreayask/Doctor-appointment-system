    ...
    <div class="body">
      ...
      <div class="left">
        ...
        <table align="center">
          ...
          <tr>
            ...
            <th>
              <font size="4" face="arial" color="gainsboro"><a href="changepassword.php" id="a">&#8196;&#8196;&#8196;&#8196;&#8196;Change Password&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;</a></font>
            </th>
          </tr>
          <tr>
            <td></td>
      ...
      <div class="right">
        ...
        <div class="admintop">
          ...
          ?>
          <h2 style="color: black; text-decoration: none;" align="center">Admin Details</h2>
          <br>
          <h3 style="color: black; text-decoration: none;">&#8196;&#8196;&#8196;&#8196;Search Admin - <input type="search" class="light-table-filter" data-table="order-table" placeholder="Search" style="font-size: 16px;" /></h3><br>


          <table class="order-table" width="1000" border="7" cellpadding="4" align="center" style="border-radius: 3px; border-color: lightslategray;">

            <thead style="font-size: 17px; background-color: lightblue;">
              <tr>
                <th width="11%" height="40">Admin ID</th>
          ...
          <td>$rs[gender]</td>
          <td>$rs[Status]</td>
          <td><a href='editadmin.php?editid=$rs[adminid]'>Edit</a> | <a href='viewadmin.php?delid=$rs[adminid]'>Delete</a> </td>
          </tr>";
              }
              ?>
            </tbody>
