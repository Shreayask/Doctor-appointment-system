        ...
        <div class="admintop">
          <div class="atl">
            ...
            <table cellspacing="5" cellpadding="3" style="background-color: white; background-image: url(https://images-na.ssl-images-amazon.com/images/I/51yaZyIPcUL._AC_SY550_.jpg); border-radius: 10px" align="center">
              <tr>
                <th><img src="https://iconarchive.com/download/i48682/custom-icon-design/pretty-office-2/add-event.ico" height="190" width="190"></th>
              </tr>
              <tr>
                <th style="background-color: mediumpurple; border: 2px lightsalmon; border-radius: 3px;"><a href="addappt.php" target="_self">
          ...
          <br><br><br>
          <table cellspacing="5" cellpadding="3" style="background-color: white; background-image: url(https://images-na.ssl-images-amazon.com/images/I/51yaZyIPcUL._AC_SY550_.jpg); border-radius: 10px" align="leftr">
            <tr>
