  ...
  if (isset($_POST['submit'])) {
    ...
    '$_POST[phoneno]','$_POST[loginid]','$_POST[password]','Active')";
      ...
      if ($chk = mysqli_query($con, $ins)) {
        ...
        echo "<script>location.href='apatient.php'</script>";
    ...
    <div class="body">
      ...
      <div class="right">
        ...
        <div class="admintop">
          ...
          <h2 align="center" style="color: black">Add New Patient Record</h2><br>
          <form method="POST" action=" " name="frmpatient" onsubmit=" return validateform()">
            <table class="tab" width="500" align="center" border="3" style="font-size: 17px; border-radius: 3px;" cellpadding="7">
              <tr>
                <td width="37%" id="x"><b>Patient Name</b></td>
                <td id="y"> <input type="text" name="patientname" style="font-size: 17px;" size="29">
                </td>
              </tr>
              <tr>
                <td id="x"><b>Address</b></td>
                <td id="y"> <input type="text" name="address" style="font-size: 17px;" size="29"></td>
              </tr>
              <tr>
                <td id="x"><b>Gender</b></td>
              ...
              <tr>
                <td id="x"><b>Blood group</b></td>
                <td id="y">
                  <select name="bloodgroup" style="font-size: 17px;">
              ...
              <tr>
                <td id="x"><b>Phone number</b></td>
                <td id="y"><input type="tel" name="phoneno" style="font-size: 17px;" size="29"></td>
              </tr>
              <tr>
                <td id="x"><b>Login Id</b></td>
                <td id="y"> <input type="text" name="loginid" style="font-size: 17px;" size="29"> </td>
              </tr>
              <tr>
                <td id="x"><b>Password</b></td>
                <td id="y"><input type="password" name="password" style="font-size: 17px;" size="29"></td>
              </tr>
              <tr>
                <td id="x"><b>Confirm Password</b></td>
                <td id="y">
                  <input type="password" name="confirmpassword" style="font-size: 17px;" size="29">
                </td>
              </tr>
              <tr>
                <td colspan="2" style="text-align: center;"> <input type="submit" name="submit" value="SUBMIT" style="font-size: 16.5px;"></td>
              </tr>
            </table>
          </form>
