...
if (isset($_POST['submit'])) {
    $sql = "UPDATE admin SET password='$_POST[newpassword]' WHERE adminid='$_GET[adminid]'";
        ...
        <div class="body">
            ...
            <form method="post" action="" name="frmpatchange" onSubmit="return validateform()">
                ...
                <table cellspacing="7" cellpadding="4" align="center" style="background-color: white; border: 2px white; border-radius: 25px; opacity: 5px;">
                    ...
                    <tr>
                        <td colspan="5">
                            <font size="3" face="cambria"><b>&#8196;New Password:&#8196;&#8196;&#8196;&#8196;&#8196;</b></font>&#8196;&#8196;<input type="password" name="newpassword" id="newpassword" class="no-outline" style="border-left: none; border-top: none; border-right: none; height: 30px; width: 315px;" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5">
                            <font size="3" face="cambria"><b>&#8196;Confirm Password:</b></font>&#8196;&#8196;<input type="password" name="password" id="password" class="no-outline" style="border-left: none; border-top: none; border-right: none; height: 30px; width: 315px;" />
                        </td>
                    </tr>
                    <tr>
                        <td></td>
