...
<head>
  ...
  if (isset($_POST['submit'])) {
    $sql = "UPDATE admin SET adminname='$_POST[adminname]', address='$_POST[address]',phonenumber='$_POST[phonenumber]',gender='$_POST[gender]',
    Status='$_POST[status]' WHERE adminid='$_GET[editid]'";
    if ($csql = mysqli_query($con, $sql)) {
      echo "<script>alert('Admin records successfully updated.') </script>";
    } else {
              ...
              <form action="" method="post" name="frmadmin" onSubmit="return validateform()">
                <table width="500" align="center" border="3" style="font-size: 17px; border-radius: 3px;" cellpadding="7">
                  <tr>
                    ...
                    <td id="y"><input type="text" name="adminid" id="adminid" value="<?php echo $rs['adminid']  ?>" <?php echo $readonly; ?> style="font-size: 16.5px;" size="29" /></td>
                  </tr>
                  <tr>
                    <td id="x">Admin Name</td>
                    <td id="y"><input type="text" name="adminname" id="adminname" value="<?php echo $rs['adminname']  ?>" style="font-size: 16.5px;" size="29" /></td>
                  </tr>
                  <tr>
                    <td id="x">Login ID</td>
                    <td id="y"><input type="text" name="loginid" id="loginid" value="<?php echo $rs['loginid']  ?>" <?php echo $readonly; ?> style="font-size: 16.5px;" size="29" /></td>
                  </tr>


                  <tr>
                    <td id="x">Address</td>
                    <td id="y"><input type="text" name="address" id="address" value="<?php echo $rs['address']  ?>" style="font-size: 16.5px;" size="29" /></td>
                  </tr>
                  <tr>
                    <td id="x">Phone number</td>
                    <td id="y"><input type="text" name="phonenumber" id="phonenumber" value="<?php echo $rs['phonenumber']  ?>" style="font-size: 16.5px;" size="29" /></td>
                  </tr>
                  <tr>
                    <td id="x">Gender</td>
                    <td id="y">
                  ...
                  <tr>
                    ...
                    <td colspan="2" align="left">&#8196;<input type="submit" name="submit" id="submit" value="SUBMIT" style="font-size: 16px;" />&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;&#8196;<button id="button"><a href="viewadmin.php" id="z">Go to Admin Lists</a> </button></td>
                  </tr>
