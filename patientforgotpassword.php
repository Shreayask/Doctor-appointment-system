...
if (isset($_POST['submit'])) {
    ...
    $user = "SELECT * FROM patient WHERE loginid='$_POST[login]' AND patientphone='$_POST[phone]'";
    $chkuser = mysqli_query($con, $user);
    $rs = mysqli_fetch_array($chkuser);
    if ((mysqli_num_rows($chkuser) == 1)) {

        echo " <script> location.href='newpatpassword.php?patientid=$rs[patientid]'</script>";
    } else {
        ...
        <div class="body">
            ...
            <form name="loginform" method="post" action="">
                ...
                <table cellspacing="7" cellpadding="4" align="center" style="background-color: white; border: 2px white; border-radius: 25px; opacity: 5px;">
                    ...
                    <tr>
                        <td colspan="5" style="text-align: center;"></a><input type="submit" name="submit" class="submit" value="    SUBMIT    " style="background-color: mediumslateblue; background-image: linear-gradient(to left, silver, thistle, mediumslateblue); border-radius: 15px" id="submit" align="center" /></td>
                    </tr>
                    <td>
                        <tr></tr>
                    </td>
