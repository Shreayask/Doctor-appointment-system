    ...
    <div class="container">
        ...
        <div class="body">
            ...
            <div class="right">
                ...
                location.href='viewappointment.php?patientid=$_GET[patientid]&doctorid=$_GET[doctorid]'</script>";
                        } else {
                            echo "<script>alert('Appointment record deleted successfully.');
                location.href='viewappointment.php?patientid=$_GET[patientid]'</script>";
                        }
                    }
                }
                ?>
                                    ...
                                    while ($rsapp = mysqli_fetch_array($csqlapp)) {
                                        ...
                                        if ($rsapp['status'] != 'Approved') {
                                            if (!(isset($_SESSION['patientid']))) {
                                                echo "<a href='admin/approveappointment.php?editid=$rsapp[appointmentid]&patientid=$rsapp[patientid]'>Approve</a><hr>";
                                            }
                                            echo "  <a href='viewappointment.php?delid=$rsapp[appointmentid]&patientid=$rspat[patientid]''>Delete</a> ";
                                        } else {
                                            if (isset($_GET['patientid']) && isset($_GET['doctorid'])) {
                                                echo "<a href='patientreport.php?patientid=$rspat[patientid]&appointmentid=$rsapp[appointmentid]'>View Report</a><hr>
                                <a href='viewappointment.php?delid=$rsapp[appointmentid]&patientid=$_GET[patientid]&doctorid=$_GET[doctorid]'>Delete</a>";
                                            } else {
                                                echo "<a href='patientreport.php?patientid=$rspat[patientid]&appointmentid=$rsapp[appointmentid]'>View Report</a> 
                               ";
                                            }
                                        }
                                        echo "</td>";
