            ...
            <div class="left">
                <h1 align="left">
                    ...
                    <font size="5" face="arial" color="gainsboro">
                        &#8196;&#8196;<a href="doctor.php" id="a"><u>Doctor Dashboard</u></a>
                    </font>
    ...
    appointment.appointmentid='$_GET[appointmentid]'";
                    ...
                    ?>
                        <form method="post" action="" name="billform">
                            ...
                            <br>
                            <table width="550" border="3" cellpadding="4" align="center" style="background-color: mistyrose; border-radius: 3px; border-color: lightslategray;">
                                <tr>
                                    <th colspan="2" style="text-align:center; background-color: mediumpurple">Treatment Details</th>

                                </tr>
                                <tr>
                                    <th style="background-color: thistle;"> Treatment</th>
                                    <th style="background-color: thistle;">Cost </th>
                                </tr>
                                <tr>
                                    <td>&#8196;Doctor fees</td>
     ...
     treatmentrecords.treatmentid=treatment.Treatmentid and treatmentrecords.appointmentid='$_GET[appointmentid]' and treatmentrecords.patientid='$_GET[patientid]'";
       ...
       ";
                                ...
                                echo "<tr> <td style='background-color: plum; font-weight: bold;'>&#8196;Total Amount</td>
    <td style='background-color: plum; font-weight: bold;'>&#8196;$totals </td></tr>";

                                ?>

                                <tr>
                                    <td style='background-color: plum; font-weight: bold;'>&#8196;Payment Status</td>
                                    <td style='background-color: plum; font-weight: bold;'>&#8196;<select name="status">
                                ...
                                <?php if (isset($_POST['submit'])) {
                                    echo "<td style='background-color: violet; font-weight: bold;'>&#8196;Total amount</td>
        <td style='background-color: violet; font-weight: bold;'>&#8196;$payrs[totalamount]</td>
        </tr>
        <tr>
        <td style='background-color: violet; font-weight: bold;'>&#8196;Status
        </td>
        <td style='background-color: violet; font-weight: bold;'>&#8196;$payrs[status]</td></tr>
        ";
                                }
                                ?>
                                ...
                                <tr>
                                    <td colspan="2" style="text-align:center;">
                                        <button id="button"><?php echo "<a href='patientreports.php?appointmentid=$_GET[appointmentid]&patientid=$_GET[patientid]&doctorid=$_GET[doctorid]' style='text-decoration: none;' >View Patient report</a>" ?></button>
                                    </td>
                                </tr>
