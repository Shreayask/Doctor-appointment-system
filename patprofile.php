        ...
        <div class="body">
            ...
            <div class="right">
                ...
                <div class="admintop">
                    ...
                    <h2 align="center" style="color: black">Patient's Profile</h2><br>
                    ...
                    <table width="500" align="center" border="3" style="font-size: 18px; border-radius: 3px;" cellpadding="7">
                        <tr>
                            ...
                            <td id="y">&#8196;&#8196;<?php echo "$rsdisplay[patientname] "; ?> </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td id="y">&#8196;&#8196;<?php echo "$rsdisplay[bloodgroup]"; ?></td>

                        </tr>
                        <tr>
                            <td id="x">&#8196;Phone number</td>
                            <td id="y">&#8196;&#8196;<?php echo "$rsdisplay[patientphone]"; ?></td>
                        </tr>
                        <tr>
                            <td id="x">&#8196;Login id
                            </td>
                            <td id="y">
                                &#8196;&#8196;<?php echo "$rsdisplay[loginid]"; ?>
                            </td>
                        </tr>
                        <tr>
